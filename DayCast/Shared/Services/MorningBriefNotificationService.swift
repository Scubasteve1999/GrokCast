...
enum MorningBriefNotificationService {
  static let enabledKey = "daycast_morning_brief_enabled"
  static let hourKey = "daycast_morning_brief_hour"
  static let requestIdentifier = "daycast.morning.brief"
  static let categoryIdentifier = "DAYCAST_MORNING_BRIEF"
  ...
  static func scheduleIfEnabled(content brief: MorningBriefContent) async {
    ...
    content.threadIdentifier = "daycast-morning-brief"
    content.userInfo = ["deepLink": DayCastDeepLinks.todayURL.absoluteString]
