...
final class PushRegistrationService {
  ...
  private let fingerprintKey = "daycast_push_registration_fingerprint"
  ...
  static var isConfigured: Bool {
    guard let base = DayCastProConfig.pushAgentBaseURL, !base.isEmpty,
      let secret = DayCastProConfig.pushAgentSharedSecret, !secret.isEmpty
    else {
      return false
    }
    return true
  ...
  private func post(path: String, body: Data) async -> Bool {
    guard let base = DayCastProConfig.pushAgentBaseURL,
      let secret = DayCastProConfig.pushAgentSharedSecret,
  ...
  private static let keychainService = "com.daycast.DayCast.push"
