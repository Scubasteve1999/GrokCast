...
final class XAIService {
  ...
  func buildWeatherSystemPrompt(for weather: DayCastWeather) -> String {
  ...
  func performAdvancedStormAnalysis(
    imageData: Data, weather: DayCastWeather?, alerts: [NWSAlert]? = nil,
  ...
  private func buildStormAnalysisBody(
    imageData: Data, weather: DayCastWeather?, alerts: [NWSAlert]?,
    severeContext: SevereWeatherContext? = nil,
    shortTermContext: ShortTermPrecipContext? = nil,
