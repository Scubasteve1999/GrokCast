...
final class NetworkMonitor {
  ...
  private let queue = DispatchQueue(label: "com.daycast.networkmonitor")
...
final class WeatherStore {
  ...
  private let temperatureUnitKey = "daycast_temperature_unit"
  ...
  private let liveActivityEnabledKey = "daycast_live_activity_enabled"
  ...
  nonisolated static var persistedLiveActivityEnabled: Bool {
    UserDefaults.standard.bool(forKey: "daycast_live_activity_enabled")
  }
  ...
  private var _notificationSoundsEnabled = DayCastNotificationSounds.isEnabled
  ...
  var notificationSoundsEnabled: Bool {
    ...
    set {
      ...
      UserDefaults.standard.set(newValue, forKey: DayCastNotificationSounds.enabledKey)
  ...
  private static let deviceLocationEntryIDKey = "daycast_device_location_entry_id"
  ...
  @MainActor
  private func publishBackgroundWeatherSurfaces(weather: DayCastWeather, locationName: String) {
    let score = DayCastScoreCalculator.score(
      for: weather, alerts: activeAlerts, units: temperatureUnit)
    let minutecast = MinutecastEngine.summary(
      from: weather.minutely15, units: temperatureUnit)
