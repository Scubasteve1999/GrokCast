...
enum FireNotificationService {
  static let categoryIdentifier = "GROKCAST_FIRE_ALERT"
  static let historyKey = "grokcast_fire_notify_history"
  ...
  private static func post(
    ...
    content.threadIdentifier = "grokcast-fire-alerts"
    content.userInfo = ["deepLink": GrokCastDeepLinks.radarURL.absoluteString]
