...
struct DayCastWatchComplicationWidget: Widget {
  let kind = "DayCastWatchComplication"
  ...
  var body: some WidgetConfiguration {
    ...
    .configurationDisplayName("DayCast")
...
@main
struct DayCastWatchWidgets: WidgetBundle {
  var body: some Widget {
    DayCastWatchComplicationWidget()
  }
}
