...
- `main` is at **1.0.7 (build 127)**. Archive exists locally
  (`~/Library/Developer/Xcode/Archives/2026-08-14/DayCast 1.0.7 (127).xcarchive`).
  Includes Today's Take 4.7 filter / report / hide and the iPhone double-tab-bar
  fix. Live on the store is still 1.0.6 (build 122) until this archive is uploaded
  and approved. Upload **127** — skip 123–126.
