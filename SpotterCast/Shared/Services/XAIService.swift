...
final class XAIService {
  ...
  func buildWeatherSystemPrompt(for weather: SpotterCastWeather) -> String {
  ...
  func performAdvancedStormAnalysis(
    imageData: Data, weather: SpotterCastWeather?, alerts: [NWSAlert]? = nil,
  ...
  private func buildStormAnalysisBody(
    imageData: Data, weather: SpotterCastWeather?, alerts: [NWSAlert]?,
