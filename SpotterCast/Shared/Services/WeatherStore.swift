...
final class WeatherStore {
  ...
  var currentWeather: SpotterCastWeather?
  ...
  // NWS: primary for SpotterCastWeather via grid (--primary-source --grid-system); alerts/obs remain additive hybrid US-only non-fatal
  ...
  private func persistWidgetSnapshot(from weather: SpotterCastWeather) {
